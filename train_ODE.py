...
Architecture:
  ...
  - Decoder:  mu(t) = rho(z(t), BMI_std(t)) @ beta_neural  ← BMI ONLY here
...
if __name__ == "__main__":
    ...
    print(f"  ODE:      dz/dt = f(z, t, static)  — NO BMI in dynamics")
    ...
    ckpt_path = "checkpoints/best_model_ode_full_skip.pt"
    ...
    # ---- Final summary ----
    print("\n" + "=" * 60)
    print("FINAL RESULTS (Neural ODE + BMI Skip)")
    print("=" * 60)
    ...
    print(f"\n  Architecture: ODE encodes time/age/glucose → z(t)")
    print(f"                Decoder sees z(t) + BMI_std + AGEc → mu(t)")
    print(f"                BMI NEVER enters ODE dynamics")
    print(f"                → PDP separation guaranteed at all times")